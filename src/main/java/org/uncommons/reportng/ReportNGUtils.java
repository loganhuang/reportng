...
public class ReportNGUtils {
    ...
    public String getSuiteName(HashMap<String, String> suitesNameMap, String suiteIndex) {
        return suitesNameMap.get(suiteIndex);
    }

    public String getResultName(HashMap<String, HashMap<String, String>> resultsNameMap, String suiteIndex, String resultIndex) {
        return resultsNameMap.get(suiteIndex).get(resultIndex);
    }


    public int getSuitesSize(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap) {
        return suitesMap.size() - 1;
    }

    public int getResultsSize(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex) {
        HashMap<String, HashMap<String, List<DataBean>>> resultsMap = suitesMap.get(suiteIndex);
        return resultsMap.size() - 1;
    }

    public List<DataBean> getFailedTests(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex, String resultIndex) {
        List<DataBean> list;
        HashMap<String, HashMap<String, List<DataBean>>> resultMap = suitesMap.get(suiteIndex);

        list = resultMap.get(resultIndex).get("failed");
        return list;
    }

    public boolean hasFailedTest(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex, String resultIndex) {
        List<DataBean> list;
        HashMap<String, HashMap<String, List<DataBean>>> resultMap = suitesMap.get(suiteIndex);
    ...
    public List<DataBean> getSkippedTests(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex, String resultIndex) {
        List<DataBean> list;
        HashMap<String, HashMap<String, List<DataBean>>> resultMap = suitesMap.get(suiteIndex);

        list = resultMap.get(resultIndex).get("skipped");
        return list;
    }

    public boolean hasSkippedTest(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex, String resultIndex) {
        List<DataBean> list;
        HashMap<String, HashMap<String, List<DataBean>>> resultMap = suitesMap.get(suiteIndex);
    ...
    public List<DataBean> getPassedTests(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex, String resultIndex) {
        List<DataBean> list;
        HashMap<String, HashMap<String, List<DataBean>>> resultMap = suitesMap.get(suiteIndex);

        list = resultMap.get(resultIndex).get("passed");
        return list;
    }

    public boolean hasPassedTest(HashMap<String, HashMap<String, HashMap<String, List<DataBean>>>> suitesMap, String suiteIndex, String resultIndex) {
        List<DataBean> list;
        HashMap<String, HashMap<String, List<DataBean>>> resultMap = suitesMap.get(suiteIndex);
